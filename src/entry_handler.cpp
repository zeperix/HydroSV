...
void log_publisher_data() {
  BOOST_LOG(info) << "Package Publisher: "sv << AQUA_PUBLISHER_NAME;
  BOOST_LOG(info) << "Publisher Website: "sv << AQUA_PUBLISHER_WEBSITE;
  BOOST_LOG(info) << "Get support: "sv << AQUA_PUBLISHER_ISSUE_URL;
}
