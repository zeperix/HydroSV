...
if(AQUA_PACKAGE_MACOS)  # todo
    ...
    install(FILES "${AQUA_SOURCE_ASSETS_DIR}/macos/misc/uninstall_pkg.sh"
            DESTINATION "${AQUA_ASSETS_DIR}")
endif()

install(DIRECTORY "${AQUA_SOURCE_ASSETS_DIR}/macos/assets/"
        DESTINATION "${AQUA_ASSETS_DIR}")
# copy assets to build directory, for running without install
file(COPY "${AQUA_SOURCE_ASSETS_DIR}/macos/assets/"
